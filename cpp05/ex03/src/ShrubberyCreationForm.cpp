...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/03/29 13:58:25 by cbitca            #+#    #+#             */
/*   Updated: 2026/03/29 13:58:39 by cbitca           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ShrubberyCreationForm& ShrubberyCreationForm::operator=(const ShrubberyCreationForm& other)
{
    if (this != &other) {
        ...
        std::cout << "ShrubberyCreationForm: copy assigment operator was called" << std::endl;
    }
    else {
        std::cout << "ShrubberyCreationForm: copy assigment operator: self-asigment ignored" << std::endl;
    }
    return *this;
}
